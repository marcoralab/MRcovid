...
exposures = c('Yengo2018bmi', 'Locke2015bmi', 'Xue2018diab', 'Willer2013hdl', 'Willer2013ldl', 'Willer2013tc', 'Willer2013tg', 'Dashti2019slepdur', 'Klimentidis2018mvpa', 'Day2018sociso', 'Evangelou2018dbp', 'Evangelou2018sbp', 'Evangelou2018pp', 'Lee2018educ', 'Okbay2016educ', 'Howard2018dep', 'Jansen2018insom', 'Liu2019smkint', 'Liu2019smkcpd', 'Liu2019drnkwk', 'Kunkle2019load', 'Revez2020vit250hd', 'Okada2014rartis', 'Nalls2019pd', 'Nicolas2018als', 'Ligthart2018crp', 'Wood2014height', 'Betham2015lupus', 'Patsopoulos2019multscler', 'Malik2018as', 'Wuttke2019egfr', 'Wuttke2019ckd', 'Nikpay2015cad', 'Shah2020heartfailure', 'Olafsdottir2020asthma', 'Allen2020ipf', 'Linner2019risk', 'Demontis2018adhd', 'Grove2019asd', 'Ripke2014scz', 'Stahl2019bip', 'Astel2016rbc', 'Astel2016wbc', 'Astel2016plt')
...
dat.plot <- exposures_outcomes %>%
  ...
  select(outcome, exposure, exposure.name, outcome.name, domain.exposure, domain.outcome, 
         z, IVW_b, IVW_se, q_signif, out, pass, pass_0.1) %>%
...
p1 <- ggplot(dat.plot) +
  geom_raster(aes(x = exposure.name, y = outcome.name, fill = IVW_b)) +
  ...
  scale_fill_gradient2(low="steelblue", high="firebrick", mid = "white", na.value = "grey75", name = "logOR") +
#  coord_fixed() +
  theme_classic() +
...
if(nrow(exposure.df) < nrow(outcome.df)){
  ...
  ggsave(glue("results/{model}/All/{model}_heatmap{DATE}.tiff"), plot = p1, width = 7, height = 11, units = "in")
  ...
  ggsave(glue("results/{model}/All/{model}_heatmap{DATE}.tiff"), plot = p1, width = 11, height = 7, units = "in")
}
